...
The `hooks` section defines hooks that nono will automatically install for specific applications. This enables sandbox-aware error handling without manual setup.
